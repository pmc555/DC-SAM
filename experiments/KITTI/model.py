...
from pareconv.modules.dual_matching import PointDualMatching1, PointDualMatching2
...
from backbone import PAREConvFPN as _BackboneV0
from backboneV1 import PAREConvFPN as _BackboneV1
...
class PARE_Net(nn.Module):
    def __init__(self, cfg):
        ...
        self.transformer = ExtendedGeometricTransformer(
    ...
    def forward(self, data_dict):
        ...
        #print(f"ref_feats_f:{ref_feats_c_norm.shape}")
        #print(f"src_feats_f:{src_feats_c_norm.shape}")
